  ...
  begin
    repeat
      ...
      begin
        ...
        Gauge1.MinValue := 0;
        Gauge1.MaxValue := jValue.GetValue<TJSonArray>('results').Count;
        ...
        for iProgress := Gauge1.MinValue to Gauge1.MaxValue do
  ...
  begin
    repeat
      ...
      begin
        ...
        case cmbSecondFilter.ItemIndex of
          0 : lbFilter := (Pos(AnsiUpperCase(edtSearch.Text), AnsiUpperCase(name)) > 0);
          1 : lbFilter := gender = edtSearch.Text;
        end;
    ...
    repeat
      ...
      begin
        ...
        begin
          ...
          //TreeView1.Items.AddChild(node, 'Opening Crawl: ' + jResult.GetValue<String>('opening_crawl'));
